    ...
    <AuthenticatedLayout>
        ...
        <Modal :show="modal" @close="closeModal()">
            ...
            <div class="p-3">
                ...
                <InputError :messaje="form.errors.name" class="mt-2"></InputError>
            </div>
            <div class="p-3">
                ...
                <InputError :messaje="form.errors.email" class="mt-2"></InputError>
            </div>
            <div class="p-3">
                ...
                <InputError :messaje="form.errors.phone" class="mt-2"></InputError>
            </div>
            <div class="p-3">
                <InputLabel for="department_id" value="Department: "></InputLabel>
                <SelectInput id="department_id" :options="departments" v-model="form.department_id" class="mt-1 block w-3/4" placeholder="Department"></SelectInput>
